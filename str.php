  ...
  foreach ($cdir as $key => $value)
  {
    ...
    if (!in_array($value,array('.','..')))
    {
       if (is_dir($dir . DIRECTORY_SEPARATOR . $value))
       {
          if ($is_key)
          {
            if ($is_add_dir) $r[$dir . DIRECTORY_SEPARATOR .$value] =  dir_to_array($dir . DIRECTORY_SEPARATOR . $value,$is_add_dir,$is_key);
            else $r[$value] = dir_to_array($dir . DIRECTORY_SEPARATOR . $value,$is_add_dir,$is_key);
          }
          else
          {
            $tmp_arr=dir_to_array($dir . DIRECTORY_SEPARATOR . $value,$is_add_dir,$is_key);
       ...
       {
          if ($is_add_dir) $r[] = $dir . DIRECTORY_SEPARATOR . $value;
          else $r[] = $value;
       }
    }
  }
